...
file_name = "/var/log/aide/aide.log"
if os.path.getsize(file_name) > 0:
	string = '''
	<html>
	<body bgcolor="#baf3ba">
	<H3>File integrity report! [ Report from:'''+ip+''' ]</H3>
	</body>
	</html>
	'''
	...
	while N < M:
		...
		main_msg['Subject'] = "[ "+host+" ] File-Integrity Daily Report!"
		main_msg['From'] = From
